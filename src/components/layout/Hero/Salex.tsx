const Sales = () => {
    return (
      <div className="custom-container flex lg:flex-row gap-12 flex-col lg:justify-between border-t-2 border-gray-dark font-custom-font lg:pt-10">
        <div className="lg:w-[487px] lg:h-auto flex flex-col items-start pr-5 mt-12 mx-12">
        ...
        <div className="lg:w-[555px] w-[500px] flex mx-auto lg:h-[555px] relative">
