const Sales = () => {
    return (
      <div className="custom-container flex lg:flex-row gap-12 flex-col lg:justify-between border-t-2 border-gray-dark font-custom-font pt-10">
        <div className="lg:w-[487px] lg:h-auto flex flex-col items-start pr-5 mt-12">
            <p className="uppercase bg-yellow lg:text-sm font-bold px-2 py-1 rounded-md mb-3">sales</p>
            <h2 className="lg:text-5xl leading-relaxed font-bold">Increase company revenue up to 65%</h2>
            ...
            <ul className="lg:text-lg mt-5">
                <li className="flex items-start mb-3"><img src="./assets/list.svg"/>
        ...
        <div className="lg:w-[555px] lg:h-[555px] relative">
