...
const Copyrights = () => {
  ...
  return (
    <div className="lg:w-[1140px] h-auto mx-auto flex lg:flex-row flex-col lg:justify-between font-custom-font text-sm items-center justify-center border-t-2 border-gray-dark py-[50px]">
